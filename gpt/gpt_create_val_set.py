...
with open("../corpora/Shakespeare_byte_test.txt", "r") as f:
...
with open('../corpora/indices_text_test.txt', 'w') as indices_text_val:
...
with open('../corpora/bytes_text_test.txt', 'w') as bytes_text_val:
