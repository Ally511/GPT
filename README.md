...
The size of the neural embedding is in some way the basis of the model. As expected there is a strong correlation between the embedding size and the perplexity performance. However, there is a limit to this, at around 512. 
