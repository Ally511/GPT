...
- get_words: extracts words from a text and returns a sorted dictionary of word counts
...
- to_byte_pair: Tokenize a string into subword units using a simple greedy byte-pair-like algorithm.
"""
...
def decode_characters(input, vocab_train):
    ...
    for i in range(0,len(input)):
        decoded.append(value_byte[input[i]]) #value_byte as translation dictionary
    # make output prettier: join list to actual words, replace underscores with spaces
...
def find_top_indices(list, n):
    """
    Gets indices of top n values in input list.
    """
